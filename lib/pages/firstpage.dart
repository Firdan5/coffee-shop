...
class MyHomePage extends StatefulWidget {
  @override
  State<MyHomePage> createState() => _MyHomePageState(); //_MyHomePageState
}
      ...
      body: Container(
        ...
        child: Stack(alignment: Alignment.center, children: [
              ...
              itemBuilder: (c, index) {
                return Column(
                  ...
                  children: [
                    ...
                    const Text(
                      "Yang terbaik dari jenisnya yang pernah Anda dapatkan dengan \n rasa yang istimewa dan berkualitas",
          ...
          Positioned(
            left: we * 0.42,
            top: he * .84,
            child: SmoothPageIndicator( //SmoothPageIndicator
              count: 3,
...
//ScaleAndFadeTransformer // PageTransformer
class ScaleAndFadeTransformer extends PageTransformer {
  ...
  @override
  Widget transform(Widget item, TransformInfo info) { //transform Widget item, TransformInfo info
    double? position = info.position;
    // double scaleFactor = (1 - position!.abs()) * (1 - _scale);
    // double fadeFactor = (1 - position!.abs()) * (1 - _fade);
    double opacity = (1 - position!.abs()) * 1;
    // double scale = _scale + scaleFactor;
    return AnimatedOpacity( // AnimatedOpacity
