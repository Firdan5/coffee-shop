...
class _CoffeePageState extends State<CoffeePage>
  ...
  Widget build(BuildContext context) { //BuildContext
    ...
    return Scaffold(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  const Text("Kaltim", style: TextStyle(color: Colors.black)),
                  SizedBox(
                    width: we * 0.27,
                  ),
                  const Icon(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(
                                        ...
                                        children: <Widget>[
                                          Text(
                                            " \Rp ${(_priceofcoffee.value * 80000).round()}",
                                            style: const TextStyle(
                                                fontSize: 17,
                                                color: Colors.white),
                                          ),
      ...
      bottomNavigationBar: FadeInUp(child: BottomNavigation()), //FadeInUp
    );
  }
}
